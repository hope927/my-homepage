...
| Endpoint | `POST https://app-dbnycdulzu2p-api-DLEO7Vjd8Qea-gateway.appmiaoda.com/rest/2.0/ocr/v1/air_ticket` |
...
async function recognizeAirTicket(options: {
  ...
  const response = await fetch(
    "https://app-dbnycdulzu2p-api-DLEO7Vjd8Qea-gateway.appmiaoda.com/rest/2.0/ocr/v1/air_ticket",
    {
      method: "POST",
      headers: {
        "Content-Type": "application/x-www-form-urlencoded",
