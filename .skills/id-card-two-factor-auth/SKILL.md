...
- **Endpoint**：`GET https://app-dbnycdulzu2p-api-oLpZ74noWOMa-gateway.appmiaoda.com/idcard`
...
async function verifyIdCardTwoFactor(
  ...
  const response = await fetch(
    `https://app-dbnycdulzu2p-api-oLpZ74noWOMa-gateway.appmiaoda.com/idcard?${params.toString()}`,
    {
      method: "GET",
      headers: {
