...
- **Endpoint**：`POST https://app-dbnycdulzu2p-api-ra5EZDjVKbza-gateway.appmiaoda.com/isbn/query`
...
async function queryIsbnInfo(isbn: string): Promise<IsbnDetail[]> {
  const url = new URL("https://app-dbnycdulzu2p-api-ra5EZDjVKbza-gateway.appmiaoda.com/isbn/query");
