...
| Endpoint | `GET https://app-dbnycdulzu2p-api-baBwZEjbe1X9-gateway.appmiaoda.com/reverse_geocoding/v3` |
...
async function reverseGeocode(
  ...
  const response = await fetch(
    `https://app-dbnycdulzu2p-api-baBwZEjbe1X9-gateway.appmiaoda.com/reverse_geocoding/v3?${params.toString()}`,
    {
      method: "GET",
      headers: {
