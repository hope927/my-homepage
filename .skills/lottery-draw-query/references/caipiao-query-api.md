...
| Endpoint | `POST https://app-dbnycdulzu2p-api-baBw2m51JXz9-gateway.appmiaoda.com/caipiao/query` |
| Auth | `platform_managed`，`X-Gateway-Authorization: Bearer ${INTEGRATIONS_API_KEY}` |
| Content-Type | `application/json` |
| Third-party Domain | `app-dbnycdulzu2p-api-baBw2m51JXz9-gateway.appmiaoda.com` |
...
async function queryCaipiaoResult(
  ...
  const url =
    `https://app-dbnycdulzu2p-api-baBw2m51JXz9-gateway.appmiaoda.com/caipiao/query?${params.toString()}`;
