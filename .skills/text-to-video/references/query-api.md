...
| Endpoint | `GET https://app-dbnycdulzu2p-api-nYWNozBb5qML-gateway.appmiaoda.com/beta/video/generations/kling/text2video` |
| 认证模式 | `platform_managed` |
| Auth Header | `X-Gateway-Authorization: Bearer ${INTEGRATIONS_API_KEY}` |
| Content-Type | `application/json` |
| 第三方域名 | `app-dbnycdulzu2p-api-nYWNozBb5qML-gateway.appmiaoda.com` |
| 说明 | 仅用于查询任务状态 |
...
async function queryTextToVideo(taskId: string): Promise<{
  ...
  const url = new URL(
    "https://app-dbnycdulzu2p-api-nYWNozBb5qML-gateway.appmiaoda.com/beta/video/generations/kling/text2video"
  );
