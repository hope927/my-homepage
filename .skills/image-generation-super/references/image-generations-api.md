...
| Endpoint | `POST http://app-dbnycdulzu2p-api-wLNdpny6ZpVa-gateway.appmiaoda.com/v1/images/generations` |
...
async function createImage(params: CreateImageParams): Promise<CreateImageResult> {
  const response = await fetch(
    "http://app-dbnycdulzu2p-api-wLNdpny6ZpVa-gateway.appmiaoda.com/v1/images/generations",
    {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
